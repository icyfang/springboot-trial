...
@EnableJpaRepositories(
        ...
        excludeFilters = {@ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.example.springjpa.multiDatasource.secondary.*")}
        //设置Repository所在位置
)
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.example.springjpa.multiDatasource.primary", "com.example.springjpa.association", "com.example.springjpa.attrOverride", "com.example.springjpa.base", "com.example.springjpa.version") //设置实体类所在位置
