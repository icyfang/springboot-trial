...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.springjpa.repository"},
        excludeFilters = {@ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.example.springjpa.repository" +
                ".secondary.*")}
) //设置Repository所在位置
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.example.springjpa.bean") //设置实体类所在位置
