package com.example.springmvc.aop.log;
...
public class LogAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.example.springmvc.swagger.UserController.*(..))")
    public void log() {
    ...
    public Object beforeLog(ProceedingJoinPoint point) throws Throwable {
        ...
        String targetMethod = String
                .format("%s#%s", point.getSignature().getDeclaringTypeName(), point.getSignature().getName());
